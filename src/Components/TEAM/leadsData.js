const leadsData = [
    { photo: "/Team/Ammar.jpeg", name: "Mohammad Ammar", position: "Mentor" },
    { photo: "/Team/Falak.png", name: "Falak Fatima", position: "Mentor" },
    { photo: "/Team/Anas.png", name: "Mohammad Anas", position: "Mentor" },
    { photo: "/Team/Haadi.png", name: "Mohammad Haadi Akhter", position: "Chairperson (Technical Affairs)" },
    { photo: "/Team/Isfar.png", name: "Isfar Ahmad Sherwani", position: "Chairperson (Operational Affairs)" },
    { photo: "/Team/Eizad.png", name: "Eizad Hamdan", position: "Vice-Chair" },
    // { photo: "/Team/Hamza.png", name: "Hamza Hyeder", position: "Secretary" },
